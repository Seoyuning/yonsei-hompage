...
(function () {
  ...
  var css =
    ...
    '.ynav-drop a:hover{color:#fff;background:rgba(58,96,170,.14)}' +
    ...
    '.ynav-spy .val{display:block;font-family:var(--kr);font-size:.96rem;font-weight:600;color:var(--coral,#3a60aa);margin-top:.15rem;transition:opacity .2s}' +
