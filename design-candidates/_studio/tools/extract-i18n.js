...
var EXTRA = [
  ...
  '조직 · 행정', '주요 연혁', '연락처 · 오시는 길',
  '교수진', '교직원',
  '연구 비전', '연구 분야', '연구실 전체', '연구실 홍보영상',
  '교육과정 개관', '이수 체계도', '졸업 요건', '전공 교과', '동아리·학생활동',
  '입학 안내', '교과목 소개', '대학원 연구실',
  '학부 공지', '대학원 공지', '뉴스 · 연구성과', '세미나 · 행사',
  '학부 입학', '대학원 진학', '장학 안내', '취업 정보', '진로 · 취업', '자주 묻는 질문', '동문',
  /* 몰입 구역 커서 라벨(data-cursor) — 링 안에 뜨는 말. 속성 스캔 대상이 아니라 여기 적는다. */
  '분야 보기', '자세히 보기',
  /* nav.js 가 그리는 헤더·푸터·오버레이. 예전엔 i18n SKIP 이라 사전에 없어도 됐지만
     이제 번역 대상이라 여기 적어 둔다(추출기는 .js 를 훑지 않는다). */
  '학부 소개', '교육목적 · 교육목표', '학위논문심사', '자료실',
  '연세대학교', '공과대학', '기계공학부 현행 홈',
  '연세대학교 기계공학부', '연세대학교 기계공학부 홈',
  '연세대학교 ↗', '공과대학 ↗', '현행 홈 ↗', '관리자',
  '(03722) 서울특별시 서대문구 연세로 50', '연세대학교 공과대학 제3공학관',
  '대표전화 02-2123-4426 (학부) · 02-2123-2810 (대학원)',
  '공모전 출품 시안(비공식)',
  '언어 선택', '주메뉴', '메뉴 열기', '메뉴 닫기', '모바일 메뉴', '모바일 주메뉴',
  '맨 위로', '사이트맵',
  /* 페이지 JS 가 그리는 목록 UI 라벨 (추출기는 .js 를 훑지 않는다) */
  '연구분야', '전체', '연구분야 :', '명',
  '프로필 · 홈페이지', '이메일', '상세 정보', '교수 프로필 새 창에서 열기 ↗'
];
