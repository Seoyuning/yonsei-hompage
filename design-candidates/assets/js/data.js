/* 연세대학교 기계공학부 — 단일 데이터 소스 (window.YSME)
   ...
   ── academicCalendar ──
   연세대학교 공식 학사일정(www.yonsei.ac.kr/sc/373)을 그대로 옮겼다.
   ...
   ※ 주석은 반드시 이 머리말(window.YSME 대입 앞)에만 둔다.
      온라인 편집기(assets/studio)가 이 파일을 JSON 으로 읽으므로,
      객체 **안에** 주석을 넣으면 「글 등록」이 JSON 해석 실패로 멈춘다. */
window.YSME = {
 "site": {
  "nameKo": "연세대학교 기계공학부",
