...
window.YSME = {
 ...
 "clusters": [
  {
   ...
   "count": 6,
   "desc": "구조와 소재가 힘을 어떻게 견디고 변형하는지가 모든 기계 시스템의 안전과 성능을 좌우합니다.",
   "intro": "구조와 소재가 힘을 어떻게 견디고 변형하는지가 모든 기계 시스템의 안전과 성능을 좌우합니다. 역학·소재 분야는 금속·복합재·연성재료의 거동을 전산 시뮬레이션과 정밀 실험으로 규명하고, 마찰과 마모(트라이볼로지), 파손, 마이크로 스케일의 응력을 함께 다룹니다. 이를 바탕으로 더 가볍고 튼튼하며 오래가는 부품과 구조를 설계합니다.",
   "theme": "mechanics"
  },
  {
   "id": "thermal",
   ...
   "count": 7,
   "desc": "에너지는 대부분 열과 유체의 흐름을 통해 만들어지고 전달됩니다.",
   "intro": "에너지는 대부분 열과 유체의 흐름을 통해 만들어지고 전달됩니다. 에너지·열유체 분야는 난류와 미세유동의 물리를 전산유체역학(CFD)과 정밀 실험으로 해석하고, 연소·청정에너지, 열전달, 연료전지·수소·배터리 같은 에너지 변환 기술을 연구합니다. 자동차부터 발전, 친환경 모빌리티까지 에너지를 더 효율적으로 다루는 과제를 풉니다.",
   "theme": "thermofluid"
  },
  {
   "id": "dynamics",
   ...
   "count": 4,
   "desc": "움직이는 모든 기계에는 동역학과 이를 다스리는 제어가 있습니다.",
   "intro": "움직이는 모든 기계에는 동역학과 이를 다스리는 제어가 있습니다. 로보틱스·제어 분야는 정밀 서보 제어와 광메카트로닉스, 인간 중심 로보틱스, 기계학습 기반 제어를 통해 기계가 스스로 감지하고 판단하며 정밀하게 움직이도록 만듭니다. 로봇, 자율 시스템, 초정밀 구동기, 진동·소음 제어가 핵심 주제입니다.",
   "theme": "control"
  },
  {
   "id": "manufacturing",
   ...
   "count": 6,
   "desc": "좋은 아이디어를 실제 제품으로 바꾸는 것은 설계와 제조 기술의 몫입니다.",
   "intro": "좋은 아이디어를 실제 제품으로 바꾸는 것은 설계와 제조 기술의 몫입니다. 설계·제조 분야는 전산 최적설계로 가장 효율적인 형상을 찾고, 극한·정밀 제조와 생산 메카트로닉스, 지능형 측정·공정으로 이를 정확하게 구현합니다. 반도체 장비, 전기차, 정밀 가공 등 첨단 제조 현장의 패러다임을 새롭게 만들어 갑니다.",
   "theme": "design"
  },
  {
   "id": "micro",
   ...
   "count": 5,
   "desc": "기계공학의 정밀 제작 기술은 마이크로·나노 스케일로 확장되고 있습니다.",
   "intro": "기계공학의 정밀 제작 기술은 마이크로·나노 스케일로 확장되고 있습니다. 마이크로·나노 분야는 MEMS와 박막·미세가공, 나노 소자·센서 기술로 눈에 보이지 않는 영역의 구조와 현상을 다룹니다. 초정밀 센서와 반도체, 차세대 소자의 토대가 되는 핵심 기술을 연구합니다.",
   "theme": "nano"
  },
  {
   "id": "optics",
   ...
   "en": "Bio & Photonics",
   "count": 5,
   "desc": "기계공학의 정밀·계측 기술은 생명과 빛의 영역으로 확장됩니다.",
   "intro": "기계공학의 정밀·계측 기술은 생명과 빛의 영역으로 확장됩니다. 바이오·포토닉스 분야는 광학·이미징과 분광, 바이오칩과 생체역학, 연성재료 기술을 결합해 질병의 조기 진단과 인체 건강에 기여하는 융합 기술을 연구합니다. 의료 광학과 바이오 센싱이 핵심 주제입니다.",
   "theme": "bio"
  }
 ],
 "professors": [
 ...
 "history": [
  ...
  {
   "date": "1999.03",
   "text": "기계공학·기계설계학과 → 기계공학전공 통합"
  },
  {
   "date": "2002.03",
   "text": "기계공학부로 분리 독립 (입학정원 180명)",
   "highlight": true
  },
  {
   "date": "2003.03",
   "text": "ABEEK 공학교육인증 프로그램 가입"
  },
  {
   "date": "2010.11",
   "text": "창립 50주년",
